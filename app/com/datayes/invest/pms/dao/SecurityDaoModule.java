...
import com.datayes.invest.pms.dao.security.impl.MarketIndexCompDaoImpl;
import com.datayes.invest.pms.dao.security.impl.MarketIndexDaoImpl;
import com.datayes.invest.pms.dao.security.impl.MarketIndexWeightDaoImpl;
...
public class SecurityDaoModule extends AbstractModule {
    ...
    protected void configure() {
        ...
        bind(MarketIndexCompDao.class).to(MarketIndexCompDaoImpl.class).in(Scopes.SINGLETON);
        bind(MarketIndexDao.class).to(MarketIndexDaoImpl.class).in(Scopes.SINGLETON);
        bind(MarketIndexWeightDao.class).to(MarketIndexWeightDaoImpl.class).in(Scopes.SINGLETON);
