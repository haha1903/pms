...
public class MarketDataServiceTest {
    ...
    private MarketData marketDataFor2 = new MarketData(securityId1, now, new Timestamp(tradeDay.toDate().getTime()), new BigDecimal(new java.math.BigDecimal(5.2d)), new BigDecimal(new java.math.BigDecimal(4.9d)), null, Source.REDIS_STOCK.toString());
    private MarketData marketDataFor4 = new MarketData(securityId2, now, new Timestamp(tradeDay.toDate().getTime()), new BigDecimal(new java.math.BigDecimal(10.1d)), new BigDecimal(new java.math.BigDecimal(10.7d)), null, Source.REDIS_STOCK.toString());
